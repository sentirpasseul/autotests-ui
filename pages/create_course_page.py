...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_create_course_button = page.get_by_test_id('create-course-toolbar-create-course-button')
        ...
        self.preview_image_upload_button = page.get_by_test_id('create-course-preview-image-upload-widget-upload-button').locator('input')
        ...
        self.exercise_delete_button = page.get_by_test_id('create-course-exercise-0-box-toolbar-delete-exercise-button')
        self.exercise_title_input = page.get_by_test_id('create-course-exercise-form-title-0-input')
        self.exercise_description_input = page.get_by_test_id('create-course-exercise-form-description-0-input')
    ...
    def check_visible_create_course_button(self):
        expect(self.create_course_create_course_button).to_be_visible()

    def click_create_course_button(self):
        self.create_course_create_course_button.click()

    def check_disabled_create_course_button(self):
        expect(self.create_course_create_course_button).to_be_disabled()
    ...
    def upload_preview_image(self, file: str):
        self.preview_image_upload_button.set_input_files(file)
